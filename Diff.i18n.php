...
$messages['be-tarask'] = array(
	'diff-desc' => 'Бібліятэка з клясамі для параўнаньня структураваных зьвестак, а таксама службовымі аб’ектамі для параўнаньня аб’ектаў і накладаньня патчаў',
);
 ...
 */
$messages['ml'] = array(
	'diff-desc' => 'രൂപഭദ്രമായ ഡേറ്റയുടെ വ്യത്യാസങ്ങളെയും, സേവന ഒബ്ജക്റ്റുകളേയും അവയുടെ വ്യത്യാസ ഒബ്ജക്റ്റുകളേയും പ്രതിനിധീകരിക്കാനും അവയിൽ മാറ്റങ്ങൾ വരുത്താനുമുള്ള ക്ലാസ്സുകളുള്ള ലൈബ്രറി',
);
 ...
 */
$messages['uk'] = array(
	'diff-desc' => "Бібліотека з класами для подання відмінностей структурованих даних, а також службовими об'єктами для порівняння об'єктів або їх виправлення",
);
